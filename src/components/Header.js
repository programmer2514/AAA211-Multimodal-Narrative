...
export default function Header({ image, title, tabIndex, links }) {
  return (
    <>
      <a className='absolute top-0 left-0 z-20 bg-white border-2 border-black px-4 py-2 transition duration-200 -translate-y-full focus:translate-y-0' role='button' tabIndex={tabIndex} href='#main'>Skip to Content</a>
